...
//
//
//        public static void lancerTestComplet(IHistorique historique, String nomStructure, int n) {
//            System.out.println("\n=== BENCHMARK : " + nomStructure + " (" + n + " éléments) ===");
//
...
//            testCoutRecherche(historique, n);
//
//            // 3. SCÉNARIO : Suppression en rafale
//            testCoutSuppression(historique, n);
//
//            // 4. MÉMOIRE (Estimation approximative en Java)
//            estimerMemoire();
//        }
//
//        private static void testCoutRecherche(IHistorique historique, int n) {
//            Random random = new Random();
//            long debut = System.nanoTime();
//
//            // On simule 1000 recherches aléatoires
//            for (int i = 0; i < 1000; i++) {
//                String idAleatoire = "ID_" + random.nextInt(n);
//                try {
...
//
//            long fin = System.nanoTime();
//            System.out.println("Coût Moyen Recherche : " + ((fin - debut)*1e-6) / n + " ms / opération");
//        }
//
